...
async function DashboardContent() {
  ...
  const getRoleIcon = (role: string) => {
    switch (role) {
      case "super_admin":
        return <Shield className="h-6 w-6 text-red-500 flex-none" />;
      case "admin":
        return <Users className="h-6 w-6 text-blue-500 flex-none" />;
      case "operator":
        return <Settings className="h-6 w-6 text-green-500 flex-none" />;
      case "coaching_staff":
        return <Activity className="h-6 w-6 text-purple-500 flex-none" />;
      default:
        return <Users className="h-6 w-6 text-gray-500 flex-none" />;
    }
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Comprehensive Taekwondo tournament management
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Actions available based on your role permissions
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 gap-4">
              {user.role === "super_admin" && (
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Manage all users, system settings, and configurations
                  </p>
                </div>
              )}
              ...
              {user.role === "operator" && (
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Operational tasks and data management
                  </p>
                </div>
              )}
              ...
              {user.role === "coaching_staff" && (
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Athlete management and coaching tools
                  </p>
                </div>
              )}
            </div>
