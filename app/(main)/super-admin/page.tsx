  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">System-wide administration and management</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">{stats.new_users_week}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600">{stats.super_admins}</div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 border border-red-200 rounded-lg bg-red-50">
                ...
                <p className="text-sm text-red-600 mt-1">Create, modify, and deactivate user accounts</p>
              </div>

              <div className="p-4 border border-blue-200 rounded-lg bg-blue-50">
                <h3 className="font-semibold text-blue-800">System Settings</h3>
                <p className="text-sm text-blue-600 mt-1">Configure system-wide settings and preferences</p>
              </div>

              <div className="p-4 border border-green-200 rounded-lg bg-green-50">
                <h3 className="font-semibold text-green-800">Database Management</h3>
                <p className="text-sm text-green-600 mt-1">Backup, restore, and maintain database integrity</p>
              </div>
            </div>
          </CardContent>
        </Card>
